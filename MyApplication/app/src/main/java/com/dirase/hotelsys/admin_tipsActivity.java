...
public class admin_tipsActivity extends AppCompatActivity {
    private Button button1,button3,button2;
    private List<String> mList1 = new ArrayList<>();
    private Context context = admin_tipsActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button2 = (Button)findViewById(R.id.history_button2);
